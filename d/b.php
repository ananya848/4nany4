...
<body>
<h1>ฟอร์มรับข้อมูล - อนัญญา ผลจันทร์ (ตาล)</h1>
...
<select name="major">
	...
	<option value="คอมพิวเตอร์ธุรกิจ">คอมพิวเตอร์ธรุกิจ</option>
</select>
<br><br>
<!--<input type="Submit" value="สมัครมาชิก">-->
...
<button type="button" onMouseOver="alert('Hey Shawty');">Hello</button>
