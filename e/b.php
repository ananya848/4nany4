...
<div class="container my-5">
    ...
    if (isset($_POST['Submit'])){
       ...
       include_once("connectdb.php");
        ...
        $sql = "INSERT INTO synergy (s_id,s_position,s_saraly,s_title,s_name,s_surname,s_birth,s_phone,s_email,s_add,s_educat,s_certi,s_work) VALUES (NULL, '{$position}','{$saraly}','{$title}','{$name}','{$surname}','{$birthday}','{$phone}','{$email}','{$address}','{$education}','{$certifications}','{$workexperience}');";
