...
<div class="container mt-5">
    <div class="card shadow-lg p-4">
        <h1 class="card-title text-center text-primary mb-4">
            ...
            ฟอร์มรับข้อมูล - อนัญญา ผลจันทร์ (ตาล) 
        </h1>
    ...
    if (isset($_POST['Submit'])){
       ...
       include_once("connectdb.php");
        ...
        $sql = "INSERT INTO register (r_id, r_name,r_phone,r_height,r_add,r_birth,r_color,r_major) VALUES (NULL, '{$fullname}','{$phone}','{$height}','{$address}','{$birthday}','{$color}','{$major}');";
